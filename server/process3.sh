...
time $CMTKDIR/warp -o ffd40.xform --grid-spacing 40 --exploration 20 --coarsest 4 --accuracy 0.6 --refine 4 --energy-weight 1e-1 -v --initial affineds.xform ${FBase}dsgf.nii.gz ${MBase}dsgfga.nii.gz
