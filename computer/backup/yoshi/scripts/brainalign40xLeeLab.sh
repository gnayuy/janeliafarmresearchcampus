...
#######################################################################
# 
# The pipeline is developed for solving 40x fly brain (0.3x0.3x0.57)
# alignment problems.
#
...
#---exe---#
$Vaa3D -x ireg -f isampler -i $SUBFLIP -o $SUBIS -p "#x 1.0 #y 1.0 #z 1.5"
...
CSVT=$LAOUTPUTC2C2"_target.csv"
CSVS=$LAOUTPUTC2C2"_subject.csv"

#---exe---#
$JBA -t $TAR -s $LAOUTPUTC2 -w 10 -o $LAOUTPUTC2C2 -L $TARLANDMARKS -B 2048 -H 2
