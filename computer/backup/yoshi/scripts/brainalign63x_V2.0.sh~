...
$ANTS 3 -m  CC[ $FIXEDDS, $MOVINGDS, 0.75, 4] -m MI[ $FIXEDDS, $MOVINGDS, 0.25, 32]  -t SyN[0.25]  -r Gauss[3,0] -o $SIMMETRIC --use-Histogram-Matching  -i $MAXITERSCC --number-of-affine-iterations $MAXITERATIONS --MI-option $MAXITERSMI
##$ANTS 3 -m  MI[ $FIXEDDS, $MOVINGDS, 1, 32] -o $RGDOUT -i 0 --use-Histogram-Matching  --number-of-affine-iterations $MAXITERATIONS --rigid-affine false
