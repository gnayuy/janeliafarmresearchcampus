...
OUTPUT=/groups/scicomp/jacsData/yuTest/flybrainAlign/source/ga_results/flybrain63x

for SUBGET in /groups/scicomp/jacsData/yuTest/flybrainAlign/source/stitched/*.v3draw
do
