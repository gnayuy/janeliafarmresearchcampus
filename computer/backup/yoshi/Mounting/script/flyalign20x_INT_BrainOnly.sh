...
echo " "
echo " USAGE ::  "
echo " sh brainalignPairPolarity_INT.sh configuration_file templates_dir toolkits_dir work_dir input_brain reference_channel voxel_size_x voxel_size_y voxel_size_z mounting_protocol"
echo " "
exit
fi
