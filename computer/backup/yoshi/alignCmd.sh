...
INPUT="$SUBTX,1,1,0.46x0.46x0.46,"

sh /groups/scicomp/jacsData/yuTest/Debug/run_configured_aligner.sh /groups/scicomp/jacsData/yuTest/YoshiMB/sources/standardbrainDPX/flyalign20xgrid.sh -w "${WORKDIR}" -c /groups/scicomp/jacsData/servers/rokicki-ws/executables/install/scripts/brainaligner/systemvars.apconf -t /groups/scicomp/jacsData/servers/rokicki-ws/executables/install/scripts/single_neuron/BrainAligner/AlignTemplates/configured_templates -k /groups/scicomp/jacsData/yuTest/toolkits -m '"DPX PBS Mounting"' -i "${INPUT}"
