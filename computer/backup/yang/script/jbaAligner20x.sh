...
#---exe---#
$BRAINALIGNER -t $TARGET -C $TARGET_REFNO -s $SUBJECT -c $SUBJECT_REFNO -w 0 -o $GAOUTPUT -B 1280 -H 2
...
#---exe---#
$BRAINALIGNER -t $TARGET -s $GAOUTPUT_C0 -w 10 -o $LAOUTPUT_C0 -L $TARGET_MARKER -B 1280 -H 2

#---exe---#
$BRAINALIGNER -t $TARGET -s $GAOUTPUT_C2 -w 10 -o $LAOUTPUT_C2 -L $CSVT -l $CSVS -B 1280 -H 2
$BRAINALIGNER -t $TARGET -s $GAOUTPUT_C1 -w 10 -o $LAOUTPUT_C1 -L $CSVT -l $CSVS -B 1280 -H 2

LA_OUTPUT=$OUTPUT"Warped.v3draw"

#---exe---#
$Vaa3D -x ireg -f mergeColorChannels -i $LAOUTPUT_C0 $LAOUTPUT_C1 $LAOUTPUT_C2 -o $LA_OUTPUT
