...
#---exe---#
$BRAINALIGNER -t $TARGET -C $TARGET_REFNO -s $SUBJECT -c $SUBJECT_REFNO -w 0 -o $GAOUTPUT -B 2048 -H 2
...
#---exe---#
$BRAINALIGNER -t $TARGET -s $GAOUTPUT_C3 -w 10 -o $LAOUTPUT_C3 -L $TARGET_MARKER -B 2048 -H 2

#---exe---#
$BRAINALIGNER -t $TARGET -s $GAOUTPUT_C0 -w 10 -o $LAOUTPUT_C0 -L $CSVT -l $CSVS -B 2048 -H 2
$BRAINALIGNER -t $TARGET -s $GAOUTPUT_C1 -w 10 -o $LAOUTPUT_C1 -L $CSVT -l $CSVS -B 2048 -H 2
$BRAINALIGNER -t $TARGET -s $GAOUTPUT_C2 -w 10 -o $LAOUTPUT_C2 -L $CSVT -l $CSVS -B 2048 -H 2
